...
This GitHub repository was created for the COMP.SE.200 Software Testing course. Its purpose is to implement automated unit tests for the JavaScript utility library provided in the course materials. The library under test is included in this project as a Git submodule and can be found under:
